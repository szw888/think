        ...
        <div class="navbar-collapse">
            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="index.html" class="active"><i class="fa fa-home nav_icon"></i>主控制台</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="widgets.html"><i class="fa fa-th-large nav_icon"></i>Widgets <span class="fa arrow"></span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="tables.html"><i class="fa fa-table nav_icon"></i>Tables<span class="fa arrow"></span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="charts.html" class="chart-nav"><i class="fa fa-bar-chart nav_icon"></i>Charts <span class="fa arrow"></span></a>
                    </li>
                </ul>
                <!-- //sidebar-collapse -->
            </nav>
